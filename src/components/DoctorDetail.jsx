...
export default function DoctorDetail({ doctor, hospitalId, onBooking, onBack }) {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Doctor Profile */}
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-blue-200/50 shadow-lg p-8 mb-8">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-6 mb-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-green-600 font-medium">{doctor.experience} experience</span>
                    </div>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-3xl font-bold text-blue-600">₹{doctor.consultationFee}</div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-blue-200/50 shadow-lg p-6 mb-6">
              <h3 className="text-xl font-bold text-gray-900 mb-6">Available Locations</h3>
                ...
                {doctor.hospitalSchedule.map((schedule) => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      <h4 className="font-semibold text-gray-900">{schedule.hospitalName}</h4>
                      <div className="flex items-center gap-1">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                      <div>
                        ...
                        <div className="font-medium text-gray-900">
                          {schedule.workDays.slice(0, 2).join(", ")}
                          {schedule.workDays.length > 2 && ` +${schedule.workDays.length - 2}`}
                        </div>
                      </div>
                      <div>
            ...
            {/* Booking Options */}
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-blue-200/50 shadow-lg p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-6">Book Appointment</h3>
              
              <div className="grid md:grid-cols-3 gap-4">
                <button
                  onClick={() => setBookingMode('next')}
                  className="p-6 rounded-xl border-2 border-dashed border-blue-300 hover:border-blue-500 hover:bg-blue-50 transition-all duration-200 group"
                >
                  <div className="text-center">
                    ...
                    <h4 className="font-semibold text-gray-900 mb-1">Next Token</h4>
                    <p className="text-sm text-gray-500">Get the next available slot</p>
                ...
                <button
                  ...
                  className="p-6 rounded-xl border-2 border-dashed border-green-300 hover:border-green-500 hover:bg-green-50 transition-all duration-200 group"
                >
                  <div className="text-center">
                    ...
                    <h4 className="font-semibold text-gray-900 mb-1">By Time</h4>
                ...
                <button
                  ...
                  className="p-6 rounded-xl border-2 border-dashed border-purple-300 hover:border-purple-500 hover:bg-purple-50 transition-all duration-200 group"
                >
                  <div className="text-center">
                    ...
                    <h4 className="font-semibold text-gray-900 mb-1">Pick Token</h4>
                    <p className="text-sm text-gray-500">Choose token number</p>
                  </div>
                </button>
              </div>
            </div>
          ...
          <div className="lg:col-span-1">
            {bookingMode && (
              <div className="bg-white/90 backdrop-blur-sm rounded-2xl border border-blue-200/50 shadow-xl p-6 sticky top-24">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-blue-200/50 shadow-lg p-6">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold text-blue-600">#{selectedHospitalSchedule.currentToken}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Avg. Time/Patient</span>
                    <span className="font-medium text-gray-900">{Math.ceil(selectedHospitalSchedule.avgSeconds / 60)} min</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Total Reviews</span>
                    <span className="font-medium text-gray-900">{doctor.totalReviews}</span>
                  </div>
                  <div className="flex justify-between items-center">
